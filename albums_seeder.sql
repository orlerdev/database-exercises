...
VALUES ('Michael Jackson', 'Thriller', 1982, 51.2, 'Pop, post-disco, funk, rock'),
       ...
       ('Meatloaf', 'Bat Out of Hell', 1977, 22, 'Hard rock, glam rock, progressive rock'),
       ...
       ('Bruce Springsteen', 'Born in the U.S.A.', 1984, 22, 'Pop, post-disco, funk, rock'),
       ('ABBA', 'Gold: Greatest Hits', 1992, 21.6, 'Pop, disco'),
       ('Dire Staits', 'Brothers in Arms', 1985, 21.1, 'Roots rock, blues rock, soft rock'),
